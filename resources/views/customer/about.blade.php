    ...
    <main class="container page-content">
        ...
        <section class="team-grid">
            <div class="team-member">
                <img src="https://via.placeholder.com/300x300/333/fff?text=Ahmed" alt="Member" class="member-img">
                <div class="member-info">
                    <h3>Ahmed Wael</h3>
                </div>
            </div>
            <div class="team-member">
                <img src="https://via.placeholder.com/300x300/444/fff?text=Omar" alt="Member" class="member-img">
                <div class="member-info">
                    <h3>Omar Zedan</h3>
                </div>
            </div>
            <div class="team-member">
                <img src="https://via.placeholder.com/300x300/555/fff?text=AbdElRahman" alt="Member" class="member-img">
                <div class="member-info">
                    <h3>AbdElRahman Hesham</h3>
                </div>
            </div>
            <div class="team-member">
                <img src="https://via.placeholder.com/300x300/666/fff?text=Omar" alt="Member" class="member-img">
                <div class="member-info">
                    <h3>Omar Tamer</h3>
                </div>
            </div>
                        <div class="team-member">
                <img src="https://via.placeholder.com/300x300/666/fff?text=Badr" alt="Member" class="member-img">
                <div class="member-info">
                    <h3>Badr Eldeen</h3>
                </div>
            </div>
