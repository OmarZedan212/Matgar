...
@php
    $allCategories = [
        'Electronics' => ['mobiles', 'laptops', 'accessories_e', 'smartwatches', 'cameras'],
    ...
    <aside class="sidebar">
        <form method="GET" action="{{ route('shop.index') }}">
            ...
            <div class="filter-group">
                ...
                @foreach($allCategories as $groupName => $items)
                    <details {{ $loop->first ? 'open' : '' }}>
                        <summary>{{ $groupName }} <i class="fa-solid fa-chevron-down"></i></summary>
        ...
        <div class="products-grid">
            @forelse($products as $p)
                ...
                <div class="card">
                    ...
                    <div class="card-info">
                        <div class="category-tag">{{ $p->category->name }}</div>
