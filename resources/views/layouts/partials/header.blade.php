...
<ul class="dropdown-menu">
    ...
    <li class="dropdown-submenu">
        <a href="shop.html?category=electronics" class="dropdown-item">
            Electronics & Gadgets <i class="fa-solid fa-angle-right"></i>
        </a>
        <ul class="dropdown-menu submenu">
            <li><a href="shop.html?category=mobiles">Mobiles</a></li>
            <li><a href="shop.html?category=laptops">Laptops</a></li>
            <li><a href="shop.html?category=accessories_e">Accessories</a></li>
            <li><a href="shop.html?category=smartwatches">Smartwatches</a></li>
            <li><a href="shop.html?category=cameras">Cameras</a></li>
        </ul>
    </li>

    <li class="dropdown-submenu">
        <a href="shop.html?category=fashion" class="dropdown-item">
            Fashion & Clothing <i class="fa-solid fa-angle-right"></i>
        </a>
        <ul class="dropdown-menu submenu">
            <li><a href="shop.html?category=mens-wear">Men’s Wear</a></li>
            <li><a href="shop.html?category=womens-wear">Women’s Wear</a></li>
    ...
    <li class="dropdown-submenu">
        <a href="shop.html?category=home" class="dropdown-item">
            Home & Living <i class="fa-solid fa-angle-right"></i>
        </a>
        <ul class="dropdown-menu submenu">
            <li><a href="shop.html?category=furniture">Furniture</a></li>
            <li><a href="shop.html?category=kitchen">Kitchen Tools</a></li>
            <li><a href="shop.html?category=appliances">Appliances</a></li>
            <li><a href="shop.html?category=decor">Decor</a></li>
        </ul>
    </li>

    <li class="dropdown-submenu">
        <a href="shop.html?category=beauty" class="dropdown-item">
            Beauty & Personal Care <i class="fa-solid fa-angle-right"></i>
        </a>
        <ul class="dropdown-menu submenu">
            <li><a href="shop.html?category=skincare">Skincare</a></li>
            <li><a href="shop.html?category=makeup">Makeup</a></li>
    ...
    <li class="dropdown-submenu">
        <a href="shop.html?category=sports" class="dropdown-item">
            Sports & Fitness <i class="fa-solid fa-angle-right"></i>
        </a>
        <ul class="dropdown-menu submenu">
            <li><a href="shop.html?category=gym">Gym Equipment</a></li>
            <li><a href="shop.html?category=sportswear">Sportswear</a></li>
            <li><a href="shop.html?category=supplements">Supplements</a></li>
            <li><a href="shop.html?category=outdoor-gear">Outdoor Gear</a></li>
        </ul>
    </li>
                    ...
                    <li>
    <a href="shop.html?sale=true" class="nav-hot">
