...
Route::middleware('auth')
    ->prefix('seller')
    ->as('seller.')
    ->controller(SellerDashboardController::class)
    ->group(function () {
...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/customer_account', function () {
...
// web.php
Route::get('/checkout', [CartController::class, 'delivery'])->name('delivery');
Route::post('/checkout/confirm', [CartController::class, 'confirmDelivery'])->name('delivery.confirm');
